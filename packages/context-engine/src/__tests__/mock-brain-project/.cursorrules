...
## Project Overview
- **Name**: app
- **Stack**: JavaScript / Plain Application
...
## Safety Zones
- Safe (1): Tests, specs, documentation — low risk
- Caution (0): Business logic, routing — review before changing
- Critical (0): Auth, DB, config, entry points — requires impact analysis
