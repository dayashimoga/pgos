...
> **Confidence**: 10% | **Generated**: 2026-05-30T05:00:00.644Z | **Engine**: PGOS AIRB v3.0.0
> **Files Analyzed**: 93 | **LOC**: 14,475 | **Duration**: 716ms
...
| **Maturity** | Growth |
| **Scale** | 93 files · 14,475 LOC |
| **Languages** | TypeScript (12666), JavaScript (1809) |
| **Classes** | 57 |
| **Functions** | 294 |
| **API Endpoints** | 93 |
| **Risk Score** | 26/100 |
...
### Executive Summary
app is a growth-grade TypeScript React application using Monorepo architecture. It contains 294 functions across 93 files with 93 API endpoints. The system implements 24 business feature(s) in the Analytics domain. Risk: 26/100. Confidence: 10%.
...
graph TD
    ...
    mod_packages_core_src___tests__["packages/core/src/__tests__"]
    mod_packages_core_src_constants["packages/core/src/constants"]
```
...
### `run()` — pure
- **Purpose**: run
- **File**: `packages/context-engine/src/__tests__/validator.test.ts` L361
- **Async**: No | **Exported**: Yes
...
- `packages/model-adapters/src/anthropic/adapter.ts` — Reads application state
...
### Async Coverage: 20/93 files use async patterns
...
**Total**: 81 | **Critical**: 27 | **Effort**: Weeks
...
### Evolution History
- **2026-05-30T05:00:00.644Z**: Brain generated. 93 files, 294 functions, 10% confidence.
...
### CRITICAL FILES (33) — DO NOT MODIFY without §15 analysis
...
app: TypeScript React app, Monorepo, 93 files, 14,475 LOC, Analytics.

**L1 — Architecture Summary** (~150 tokens)
Monorepo with 2 layers. 93 endpoints, 57 classes, Custom Auth/JWT auth. Risk: 26/100.
...
| Check | Status |
|-------|--------|
| Real function bodies | YES (294) |
| Stub/placeholder files | WARNING (17) |
...
*Generated by PGOS AIRB v3.0.0 | 2026-05-30T05:00:00.644Z | DO NOT EDIT MANUALLY*
