...
## Safety Zones
- Safe (24): Tests, specs, documentation — low risk
- Caution (36): Business logic, routing — review before changing
- Critical (33): Auth, DB, config, entry points — requires impact analysis
